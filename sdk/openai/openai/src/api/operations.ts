...
export async function getEmbeddings(context: Client, input: string | string[], deploymentId: string, options: GetEmbeddingsOptions = { requestOptions: {} }): Promise<DeploymentEmbeddingsOptionsEmbeddings> {
 ...
 */
export async function getChatCompletions(context: Client, messages: ChatMessage[], deploymentId: string, options: GetChatCompletionsOptions = { requestOptions: {} }): Promise<DeploymentChatCompletionsOptionsChatCompletions> {
    const result = await context
...
export async function getCompletions(context: Client, deploymentId: string, options?: GetCompletionsOptions): Promise<DeploymentCompletionsOptionsCompletions>;
export async function getCompletions(context: Client, deploymentId: string, prompt: string, options?: GetCompletionsOptions): Promise<DeploymentCompletionsOptionsCompletions>;
export async function getCompletions(context: Client, deploymentId: string, prompt: string[], options?: GetCompletionsOptions): Promise<DeploymentCompletionsOptionsCompletions>;
export async function getCompletions(context: Client, deploymentId: string, options?: GetCompletionsOptions): Promise<DeploymentCompletionsOptionsCompletions>;
export async function getCompletions(context: Client, deploymentId: string, prompt: string, options?: GetCompletionsOptions): Promise<DeploymentCompletionsOptionsCompletions>;
export async function getCompletions(context: Client, deploymentId: string, prompt: string[], options?: GetCompletionsOptions): Promise<DeploymentCompletionsOptionsCompletions>;
 ...
 * provided prompt data.
 */
export async function getCompletions(context: Client, deploymentId: string, inputPromptOrOptions?: string | string[] | GetCompletionsOptions, options: GetCompletionsOptions = { requestOptions: {} }): Promise<DeploymentCompletionsOptionsCompletions> {
 ...
 * provided prompt data.
 */
async function _getCompletions(context: Client, deploymentId: string, options: GetCompletionsOptions = { requestOptions: {} }): Promise<DeploymentCompletionsOptionsCompletions> {
    const result = await context
